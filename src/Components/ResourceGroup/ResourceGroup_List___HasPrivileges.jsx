...
import { ReactComponent as IconBIG } from '../icons/ico-hasprivileges.svg';
import { ReactComponent as IconSettings } from '../icons/ico-settings.svg';
 ...
 import jsonData from '../../tmpjsons/ResourceGroup-HasPrivileges.json'; // Adjust the path as needed based on your project structure
...
<div className='resource-group-list-item list-item-small   '>
<p className='font-type-menu  make-underline Color-Grey1 '>Can Watch</p>
</div>
<div className='resource-group-list-item list-item-small  '>
<p className='font-type-menu  make-underline Color-Grey1 '>Can Edit</p>
</div>
<div className='resource-group-list-item list-item-small  '>
...
<div className='resource-group-list-item list-item-small display-flex' >
  ...
  <div className={`    ${StatusColorClass}  light-bulb-type1`}/><button className="btn-type1"> </button>
  </div>
