...
<div className='resource-group-list-headline-left ' ><IconBIG/> <p className='font-type-h4   Color-White ml-b'>LeakCheck list</p></div>
...
<div className='resource-group-list-keyNames mb-a  '  >
             ...
             <div className='resource-group-list-item   list-item-big ml-b'>                                                    <p className='font-type-menu  no-underline Color-Grey1 '>Name</p></div>
             ...
             <div className='resource-group-list-item list-item-small' onClick={() => do_sort("LastIntervalDate")}>             <p className='font-type-menu  make-underline Color-Grey1 '>Success</p></div>
             ...
             <div className='resource-group-list-item list-item-small ' onClick={() => do_sort("Status")}  style={{ marginRight: "25px"}}>   <p className='font-type-menu  make-underline Color-Grey1 '>Found</p></div>
</div>
...
{/* <p className='resource-group-list-item    font-type-txt   Color-Grey1  list-item-big   '>{ JSON.stringify(Info?.Arguments) }</p>  */}
 ...
 <p className='resource-group-list-item    font-type-txt   Color-Grey1  list-item-big  ml-b '>{ Info?.Name }</p> 
<p className='resource-group-list-item  font-type-txt  Color-Grey1 list-item-biggest'>{ JSON.stringify(Info?.Response?.result) }</p> 
<p className='resource-group-list-item  font-type-txt  Color-Grey1  list-item-small'>{Info?.Response?.success ? ("True"): ("False")}</p> 
<p className='resource-group-list-item  font-type-txt  Color-Grey1  list-item-small'>{Info?.Response?.quota}</p> 
<p className='resource-group-list-item  font-type-txt  Color-Grey1  list-item-small'>{Info?.Response?.found}</p> 
